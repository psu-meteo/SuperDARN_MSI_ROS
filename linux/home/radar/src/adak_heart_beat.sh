...
####################################
DIR="/data/ros/fitacf/"
QNX_ROS_STOP="ssh -p 8022 root@adak-ros /root/current_ros/stop.ros"
QNX_ROS_START="ssh -p 8022  root@adak-ros /root/current_ros/start.ros"
QNX_REBOOT=""
LNX_ROS_STOP="stop.radar"
LNX_ROS_START="start.radar"
LNX_ROS_REBOOT=""
QNX_TEST_CMD="ssh -p 8022 root@adak-ros  date -u"

EMAIL_RADAR="ADAK"
EMAIL_FROM="ADAK_radar_ops@superdarn.gi.alaska.edu"
