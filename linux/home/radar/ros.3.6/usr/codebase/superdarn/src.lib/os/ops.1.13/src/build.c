...
2011Jan13 22:13:00 KTS

Jef found a small bug with the OpsBuildIQ function that randomly caused Kodiak and 
McMurdo to crash.  The crash seemed more apparent with the multiple channel operation
and the file here reflects changes to correct the issue.
