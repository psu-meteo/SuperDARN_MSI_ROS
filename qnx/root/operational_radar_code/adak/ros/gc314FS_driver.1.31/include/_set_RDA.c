...
if(channel==CHANNEL_A){
	...
	write32(BASE1, GC314FS_R1BSM,		0x2a8);
	write32(BASE1, GC314FS_R2BSM,		0x2a8);
	write32(BASE1, GC314FS_R3BSM,		0x2a8);
}
	...
	write32(BASE1, GC314FS_R1CSM,		0x2a8);
	write32(BASE1, GC314FS_R2CSM,		0x2a8);
	write32(BASE1, GC314FS_R3CSM,		0x2a8);
}
	...
	write32(BASE1, GC314FS_R1DSM,		0x2a8);
	write32(BASE1, GC314FS_R2DSM,		0x2a8);
	write32(BASE1, GC314FS_R3DSM,		0x2a8);
}
