...
#define SITE_DIR "/root/operational_radar_code/kod/site_data/"
...
#ifdef __QNX__
  #define DIO_HOST_IP "192.168.10.2"
  #define TIMING_HOST_IP "192.168.10.2"
  #define DDS_HOST_IP "192.168.10.2"
