  ...
  if (arg!=NULL) {
    if (arg->state!=NULL) {
      ...
      if (arg->data->status==0 ) {
        ...
        //printf("RECV: GET_DATA: shm_memory %d\n",arg->data->shm_memory);
        recv_data(recvsock,&arg->data->frame_header,sizeof(arg->data->frame_header));
        //printf("RECV: GET_DATA: frame_header %d\n",arg->data->frame_header);
        recv_data(recvsock,&arg->data->bufnum,sizeof(arg->data->bufnum));
        //printf("RECV: GET_DATA: bufnum %d\n",arg->data->bufnum);
        recv_data(recvsock,&arg->data->samples,sizeof(arg->data->samples));
        //printf("RECV: GET_DATA: samples %d\n",arg->data->samples);
        recv_data(recvsock,&arg->main_address,sizeof(uint64_t));
        recv_data(recvsock,&arg->back_address,sizeof(uint64_t));
        //printf("RECV: GET_DATA: main_address %p %d\n",arg->main_address,sizeof(arg->main_address));
        //printf("RECV: GET_DATA: back_address %p %d\n",arg->back_address,sizeof(arg->back_address));
...
//                            arg->back_address);
        ...
        //printf("RECV: GET_DATA: outside of memory space setup\n");
      ...
      //printf("RECV: GET_DATA: error_flag: %d\n",error_flag);

      if (error_flag==0) {
        //printf("RECV: GET_DATA: reading to recv final Msg\n");
        recv_data(recvsock, &msg, sizeof(struct DriverMsg));
        //printf("RECV: GET_DATA: recv'd RosMsg\n");
      }
